...
if("FALSE" STREQUAL "TRUE")
  set(turtlebot3_description_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-turtlebot3-description-0.2.1)
  set(turtlebot3_description_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-turtlebot3-description-0.2.1/obj-x86_64-linux-gnu/devel)
  ...
  set(turtlebot3_description_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot3_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
