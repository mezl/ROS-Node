...
GY87::GY87(ros::NodeHandle nh){
	...
	ROS_INFO("GY87: Init Publishers...");
        pub_imu_ = nh.advertise<sensor_msgs::Imu>("imu", 1000);
...
void GY87::publish(){
	...
	msg_imu_.header.frame_id = "imu_link";
        msg_imu_.header.stamp = measurement_time;
	...
	msg_mag_.header.frame_id = "mag_link";
        msg_mag_.header.stamp = measurement_time;
